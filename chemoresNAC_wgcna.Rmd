...
module_enrichment_analysis(geneInfo, "grey", GS=0.15, MM = 0.7)
module_enrichment_analysis(geneInfo, "yellow", GS=0.15, MM=0.7)
module_enrichment_analysis(geneInfo, "turquoise", GS=0.15, MM=0.7)
```  

## Network construction with DIAMOnD  

```{r}
expand_module <- function(module, n=300, network_path){
