...
network_building <- function(genes_file_path){
  ...
  hub_score1 <- scores[as.character(network$gene_id1)]
  hub_score2 <- scores[as.character(network$gene_id2)]
  combined_score <- (hub_score1+hub_score2) / 2
  network <- network %>%
    dplyr::mutate(gene_symbol1 = gene_symbol1, 
                  gene_symbol2 = gene_symbol2, 
                  hub_score1 = hub_score1, 
                  hub_score2 = hub_score2, 
